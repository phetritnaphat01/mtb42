...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const navItems = [
    { id: 'table', label: 'รายการฎีกาเบิกจ่าย', icon: FileText, adminOnly: false },
    { id: 'charts', label: 'กราฟจำแนกงบประมาณ', icon: BarChart3, adminOnly: false },
    { id: 'system', label: 'จัดการระบบ', icon: Settings, adminOnly: true },
    { id: 'login-history', label: 'ประวัติการเข้าสู่ระบบ', icon: History, adminOnly: true },
    { id: 'permissions', label: 'จัดการสิทธิ์', icon: ShieldCheck, adminOnly: true },
  ];
    ...
    <>
      ...
      `}>
        ...
        <div className="flex-1 overflow-y-auto px-3 py-4 space-y-1">
          ...
          {/* Export & Utility Actions under Main Menu (Collapsible - Admin Only) */}
          {isUserAdmin && (
